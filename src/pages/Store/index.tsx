      ...
      <div>
        ...
        <div className="relative pt-2 p-4 flex flex-col gap-4 max-w-xl mx-auto">
          ...
          <div className="bg-core-black-contrast-2 rounded p-4">
            ...
            <p className="text-xs text-core-grey-20 mb-3">Lorem ipsum dolor sit amet consectetur. Tortor ridiculus nisl mollis est. Diam rutrum adipiscing nunc dignissim massa egestas sit. Ac ac ultrices id malesuada eget proin morbi adipiscing. Imperdiet duis eu facilisis sapien in ultricies proin</p>
            <p className="text-xs">Read more</p>
          </div>
          <div className="text-right text-primary flex gap-3 items-center justify-end">
            Install all
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M2.3077 15.9997C1.80257 15.9997 1.375 15.8247 1.025 15.4747C0.675 15.1247 0.5 14.6971 0.5 14.192V11.4997H1.99997V14.192C1.99997 14.2689 2.03202 14.3394 2.09612 14.4036C2.16024 14.4677 2.23077 14.4997 2.3077 14.4997H13.6922C13.7692 14.4997 13.8397 14.4677 13.9038 14.4036C13.9679 14.3394 14 14.2689 14 14.192V11.4997H15.5V14.192C15.5 14.6971 15.325 15.1247 14.975 15.4747C14.625 15.8247 14.1974 15.9997 13.6922 15.9997H2.3077ZM7.99997 12.1151L3.7308 7.84588L4.78462 6.76131L7.25 9.22668V0.82666H8.74995V9.22668L11.2153 6.76131L12.2691 7.84588L7.99997 12.1151Z" fill="#31CEFF"/>
            </svg>
          </div>
          <div className="overflow-hidden flex-grow lg:px-0">
            <div className="bg-core-black-contrast-2 rounded overflow-hidden flex justify-start items-stretch h-full">
              ...
              <div className="pr-4 flex items-center">
                <button className={`active:scale-95 transition bg-core-grey-20 mx-auto text-sm text-center w-fit rounded text-black px-5 py-1.5 rounded-full`}>
                  Install
                </button>
              </div>
            </div>
